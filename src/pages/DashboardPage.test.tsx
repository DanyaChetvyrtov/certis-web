...
describe('DashboardPage', () => {
    ...
    it('shows empty category history and an expense breakdown from analytics', async () => {
        let analyticsQuery: Record<string, string> | undefined
        ...
        expect(await within(historyPanel as HTMLElement)
            .findByText('No category history yet'))
            .toBeInTheDocument()
        expect(within(historyPanel as HTMLElement).queryByText('Coming soon'))
    ...
    it('loads category spending history once per dashboard currency', async () => {
        const historyQueries: Record<string, string>[] = []
        ...
        await waitFor(() => expect(historyQueries).toEqual([{
            month: currentMonth(),
            currency: 'EUR',
            type: 'EXPENSE',
            bucketCount: '6',
