...
import {
    useDashboardCategorySpendingOverTime,
} from '../features/dashboard/hooks/useDashboardCategorySpendingOverTime'
...
export function DashboardPage() {
    ...
    const {
        spendingOverTime: categorySpendingOverTime,
        loadState: categorySpendingOverTimeState,
        reload: reloadCategorySpendingOverTime,
    } = useDashboardCategorySpendingOverTime(
        currentMonth,
        selectedCurrency,
        !isProfileSetupOpen,
        ...
        <div className={`dashboard-shell${isProfileSetupOpen ? ' dashboard-modal-open' : ''}`}>
            ...
            <main className="dashboard-content">
                ...
                <CategorySpendingPanels
                    ...
                    spendingOverTime={categorySpendingOverTime}
                    spendingOverTimeLoadState={categorySpendingOverTimeState}
                    onRetrySpendingOverTime={reloadCategorySpendingOverTime}
                />
            </main>
